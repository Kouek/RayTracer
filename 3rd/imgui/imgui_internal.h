...
{
    int                     LastActiveFrame;
    int                     StackLevel;                 // -1: query stack and onResized Results, >= 0: individual stack level
...
struct ImGuiContext
{
    ...
    // Navigation: Windowing (CTRL+TAB for list, or Menu button + keys or directional pads to move/onResized)
...
struct IMGUI_API ImGuiWindowTempData
{
    ...
    ImVec2                  CursorMaxPos;           // Used to implicitly calculate ContentSize at the beginning of next frame, for scrolling range and auto-onResized. Always growing during the frame.
    ImVec2                  IdealMaxPos;            // Used to implicitly calculate ContentSizeIdeal at the beginning of next frame, for auto-onResized only. Always growing during the frame.
    ImVec2                  CurrLineSize;
    ImVec2                  PrevLineSize;
...
struct IMGUI_API ImGuiWindow
{
    ...
    signed char             ResizeBorderHeld;                   // Current border being held for onResized (-1: none, otherwise 0-3)
